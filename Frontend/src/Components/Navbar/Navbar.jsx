    ...
    <nav className="bg-white shadow-md fixed w-full top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-4">
          ...
          <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 cursor-pointer" onClick={()=>navigate('/signup')}>
            Sign Up
          </button>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md px-6 py-4 space-y-4">
          ...
          <button className="w-full border bg-blue-600 border-blue-600 py-2 rounded-lg text-white cursor-pointer">
            Sign Up
          </button>
        </div>
      )}
